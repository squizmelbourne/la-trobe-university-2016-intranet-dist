 ...
 * change log:
 *     Mon Mar 27 2017 16:13:47 GMT+1100 (AEDT) - First revision
 */
    ...
    handleClicks: function handleClicks() {
        ...
        $arrows.on('click.mobile', function (ev) {
            ...
            if ($megamenu.is(':visible')) {
                ...
                console.log('megamenu not visible');
...
(function () {
    window.onload = function () {
        ...
        window.matchMedia(minMq).addListener(function (mql) {
            if (!mql.matches) {
                console.log('init addListener');
                mobileMegaMenu.init();
            } else {
                console.log('reset/destroy addListener');
        ...
        $('body').on('click', '.navbar__toggle', function () {
            console.log('click navbar__toggle');
            mobileMegaMenu.reset();
            mobileMegaMenu.destroy();
            mobileMegaMenu.init();
        });
