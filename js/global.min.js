 ...
 * change log:
 *     Fri Mar 17 2017 17:16:44 GMT+1100 (AEDT) - First revision
 */
            ...
            jsAPI.getMetadata({
                ...
                'dataCallback': function dataCallback(obj) {
                    if (obj.errorCode && obj.errorCode === 'permissionError') {
                        ...
                        console.log('fires');
                        //$('#' + metaName.replace(/\./g,'-')).val(jsonObj[metaName]);
                        //makeAJAXCall('GET', recacheUrl, renderMetadata).then(function(results){
                        //   console.log('done');
                        //});

                        $.get(recacheUrl, function (data) {
                            var jsonObj = JSON.parse(data);
                            console.log(jsonObj[metadataName]);
