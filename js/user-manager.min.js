...
var navUserHandler = {
    ...
    init: function init(el, resolve) {
        ...
        // Ensure Varnish cache is cleared before fetching the nav user
        $.ajax({
            url: 'https://intranetdev.latrobe.edu.au/clearusercache',
            type: 'get',
            success: function success() {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        mobiletoggle: navUserHandler.settings.mobiletoggle //eslint-disable-line
                    },
