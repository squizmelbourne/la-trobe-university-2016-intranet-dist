 ...
 * modified: Mon Mar 27 2017 09:21:12 GMT+0200 (CEST)
 * @preserve
 */
        ...
        setState: function setState($item, active) {
            ...
            if (active) {
                ...
                $('body').on('click.megamenu', function (event) {
                    ...
                    var clickedOutisde = targetClassList.length ? !document.querySelector('.nav-main--desktop').querySelector(targetClassList) : true;
